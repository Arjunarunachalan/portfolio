...
export default function Home() {
  return (
    <div className="min-h-screen bg-background  md:py-[30px] py-[20px]">
      {/* hero */}
      <section className=" w-full flex md:flex-row flex-col pt-3 md:px-[100px] px-[15px]">
        {/* Left Section */}
        <div className="md:w-[60%] w-full flex flex-col justify-center items-center ">
          <div className="w-full h-full flex justify-center items-start text-start flex-col gap-5">
      ...
      <section
        ...
        className="w-full px-0 bg-bg_light flex flex-col  gap-4 justify-center items-center h-[300px] md:h-[250px] shadow-xl">
      ...
      <section className="w-full flex flex-col pt-3 md:px-[100px] px-[15px] md:py-[40px] py-[20px]">
        ...
        {/* projects */}
        <div className="w-full flex flex-col pt-[20px] md:py-[40px] py-[20px]">
